...
if __name__ == "__main__":
    ...
    seed_dict = {'cora': 2300, 'citeseer': 2839, 'pubmed': 3333}
    import wandb
    wandb.init(project="gnn_prune", name='random_pruning'+ '_' + args['dataset'])
    ...
    for p, (adj_percent, wei_percent) in enumerate(percent_list):
        ...
        wandb.log(wandb_log)
        val.append(best_acc_val * 100)
        test.append(final_acc_test * 100)
        Adj.append(adj_spar)
        Wei.append(wei_spar)
    print('val',val)
    print('test',test)
