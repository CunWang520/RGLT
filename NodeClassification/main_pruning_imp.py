...
def run_fix_mask(args, seed, rewind_weight_mask):
    ...
    # print('idx_train',len(idx_train),idx_train)
    # idx_train = idx_train+idx_test[:300]
    # idx_test = idx_test[300:]
    # print('idx_val', len(idx_val), idx_val)
...
def parser_loader():
    ...
    parser.add_argument('--exp_name', type=str, default='gcn_imp')
    ...
    parser.add_argument('--embedding-dim', nargs='+', type=int, default=[3703, 512, 6])#1433 512 7  3703,16,6
...
if __name__ == "__main__":
    ...
    print(args)
    wandb.init(project="gnn_prune_03", name=args['exp_name']+'_'+args['dataset'])
    seed_dict = {'cora': 2377, 'citeseer': 4428, 'pubmed': 3300} 
