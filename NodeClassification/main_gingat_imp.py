...
def parser_loader():
    ...
    parser.add_argument('--exp_name', type=str, default='_imp',help='scale sparse rate (default: 0.0001)')
...
if __name__ == "__main__":
    ...
    # print(args)
    wandb.init(project="gnn_prune", name=args['net']+args['exp_name'] + '_' + args['dataset'])
    rewind_weight = None
