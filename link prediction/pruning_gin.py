...
def get_final_mask_epoch02(model, rewind_weight, args,adj_grad,wei_01_grad,wei_02_grad):
    ...
    rewind_weight['gcn.adj_mask1_train'] = get_each_mask02(ori_adj_mask, adj_thre,adj_grad,percent=adj_percent,adj=True)
    rewind_weight['gcn.adj_mask2_fixed'] = rewind_weight['gcn.adj_mask1_train']

    rewind_weight['gcn.ginlayers.0.apply_func.mlp.linear.weight_mask_train'] = get_each_mask02(
        model.gcn.ginlayers[0].apply_func.mlp.linear.state_dict()['weight_mask_train'], wei_thre,wei_01_grad,percent=wei_percent)
    rewind_weight['gcn.ginlayers.0.apply_func.mlp.linear.weight_mask_fixed'] = rewind_weight[
        'gcn.ginlayers.0.apply_func.mlp.linear.weight_mask_train']

    rewind_weight['gcn.ginlayers.1.apply_func.mlp.linear.weight_mask_train'] = get_each_mask02(
        model.gcn.ginlayers[1].apply_func.mlp.linear.state_dict()['weight_mask_train'], wei_thre,wei_02_grad,percent=wei_percent)
    rewind_weight['gcn.ginlayers.1.apply_func.mlp.linear.weight_mask_fixed'] = rewind_weight[
        'gcn.ginlayers.1.apply_func.mlp.linear.weight_mask_train']

    adj_spar = rewind_weight['gcn.adj_mask2_fixed'].sum() * 100 / model.gcn.edge_num
    wei_nonzero = rewind_weight['gcn.ginlayers.0.apply_func.mlp.linear.weight_mask_fixed'].sum() + rewind_weight[
        'gcn.ginlayers.1.apply_func.mlp.linear.weight_mask_fixed'].sum()
    wei_all = rewind_weight['gcn.ginlayers.0.apply_func.mlp.linear.weight_mask_fixed'].numel() + rewind_weight[
        'gcn.ginlayers.1.apply_func.mlp.linear.weight_mask_fixed'].numel()
    wei_spar = wei_nonzero * 100 / wei_all
...
def get_each_mask02(mask_weight_tensor, threshold,grad,percent,adj=False):
    ...
    reactivate_num = int(0.001*total_zero)
